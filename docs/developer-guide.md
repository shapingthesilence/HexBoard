...
- `src/firmware/midi/`: standalone USB/serial transport in `MidiTransport.cpp`, standalone MPE/routing in `MidiRouting.cpp`, plus unity-included MIDI note dispatch, external MIDI LED state, delegated control, and MIDI input parsing

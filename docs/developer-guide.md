...
- built-in tuning, layout, and scale catalogs are exposed as generated read-only
  ...
  `/layouts.dat`; the on-device geometry browsers show geometry entries as flat
  names while the web app keeps foldered organization

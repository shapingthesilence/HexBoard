...
constexpr uint8_t PRESET_SYNC_TLV_TUNING_PERIOD_CENTS_FLOAT32 = 0x29;
constexpr uint8_t PRESET_SYNC_TLV_TUNING_STEP_CENTS_FLOAT32 = 0x2A;
constexpr uint8_t PRESET_SYNC_TLV_TUNING_REFERENCE_HZ_FLOAT32 = 0x2B;
constexpr uint8_t PRESET_SYNC_TLV_TUNING_CENTS_TABLE_FLOAT32 = 0x2C;
...
constexpr uint8_t PRESET_SYNC_TLV_LAYOUT_DEVICE_ROTATION = 0x27;
constexpr uint8_t PRESET_SYNC_TLV_LAYOUT_ROTATION = 0x28;
constexpr uint8_t PRESET_SYNC_TLV_LAYOUT_MIRROR_FLAGS = 0x29;
constexpr uint8_t PRESET_SYNC_TLV_LAYOUT_CENTER_STEPS_FROM_C = 0x2A;
...
constexpr uint8_t PRESET_SYNC_TLV_SCALE_COLOR_DEFAULT_COLOR_MODE = 0x22;
...
constexpr uint8_t PRESET_SYNC_TLV_USER_SCALE_ROOT_DEGREE = 0x22;
constexpr uint8_t PRESET_SYNC_TLV_USER_SCALE_PATTERN_STEPS = 0x23;
...
constexpr uint8_t PRESET_SYNC_TLV_BUTTON_MAP_ACTIONS = 0x24;

constexpr uint8_t PRESET_SYNC_USER_TUNING_KIND_EDO = 1;
constexpr uint8_t PRESET_SYNC_USER_TUNING_KIND_CENTS_LIST = 2;
constexpr uint8_t PRESET_SYNC_USER_TUNING_KIND_RATIO_LIST = 3;
...
constexpr uint8_t PRESET_SYNC_BUTTON_MAP_RECORD_FORMAT_FIXED = 1;
constexpr uint8_t PRESET_SYNC_BUTTON_MAP_RECORD_FORMAT_FIELD_MASKED = 2;
constexpr uint8_t PRESET_SYNC_BUTTON_MAP_FIELD_ROLE = 1u << 0;
constexpr uint8_t PRESET_SYNC_BUTTON_MAP_FIELD_PITCH = 1u << 1;
constexpr uint8_t PRESET_SYNC_BUTTON_MAP_FIELD_COLOR = 1u << 2;
constexpr uint8_t PRESET_SYNC_BUTTON_MAP_FIELD_ACTION = 1u << 3;
constexpr uint8_t PRESET_SYNC_BUTTON_OUTPUT_TUNED = 0;
constexpr uint8_t PRESET_SYNC_BUTTON_OUTPUT_DIRECT_MIDI = 1;
constexpr uint8_t PRESET_SYNC_BUTTON_OUTPUT_CHORD = 2;
constexpr uint8_t PRESET_SYNC_BUTTON_ACTION_CHORD = 1;
constexpr uint8_t PRESET_SYNC_CHORD_PITCH_TUNING_STEPS = 0;
constexpr uint8_t PRESET_SYNC_CHORD_PITCH_MIDI_SEMITONES = 1;
constexpr uint8_t PRESET_SYNC_BUTTON_MAP_FIELD_MASKED_RECORD_SIZE = 17;
constexpr uint8_t PRESET_SYNC_MAX_CHORD_ACTIONS = 16;
constexpr uint8_t PRESET_SYNC_MAX_CHORD_TONES = 4;
...
constexpr uint8_t PRESET_SYNC_RECORD_VALID = 0x01;
constexpr uint8_t PRESET_SYNC_RECORD_READ_ONLY = 0x02;
...
constexpr uint32_t PRESET_SYNC_CAP_FACTORY_GEOMETRY = 1u << 10;
...
constexpr uint32_t PRESET_SYNC_CAP_SCOPED_GEOMETRY_LIST = 1u << 16;
...
constexpr uint8_t PRESET_SYNC_ERROR_WRITE_PROTECTED = 0x0A;

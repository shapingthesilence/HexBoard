...
void drawStandardMeter() {
  ...
  int defaultX = kMeterInnerX + valueToMeterWidth(overlayDefaultValue);
  u8g2.drawVLine(defaultX, kMeterY - 3, 3);
  u8g2.drawVLine(defaultX, kMeterY + kMeterHeight, 3);
}
...
void RAM_FUNC(notifyCommandWheelOverlay)(CommandWheelOverlayType type,
  ...
  overlayDefaultValue = defaultValue;
  overlayActive = true;

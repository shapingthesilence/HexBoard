...
constexpr uint8_t SYNTH_CONTROL_RATE_SAMPLES = 32;
constexpr uint8_t SYNTH_CONTROL_RATE_SHIFT = 5;
...
constexpr uint8_t SYNTH_WAVETABLE_FRAME_COUNT = 16;
constexpr uint8_t SYNTH_WAVETABLE_LAST_FRAME = SYNTH_WAVETABLE_FRAME_COUNT - 1;
constexpr std::array<uint8_t, SYNTH_WAVETABLE_FRAME_COUNT> SYNTH_WAVETABLE_FRAME_POSITION_AMOUNTS = {
...
constexpr uint16_t SYNTH_WAVETABLE_MIP_HARMONIC_LIMIT_0 = 192;
...
constexpr uint8_t SYNTH_WAVETABLE_MIP_BRIGHT_SELECT_THRESHOLD = 192;
constexpr uint8_t SYNTH_WAVETABLE_CONTEXT_RATE_DIVIDER = 2;
...
constexpr byte SYNTH_VIBRATO_SPEED_NOISE = 12;  // 12 Hz smooth-noise vibrato after the 1..12 Hz sine values.
constexpr byte SYNTH_VIBRATO_SPEED_MAX = SYNTH_VIBRATO_SPEED_NOISE;

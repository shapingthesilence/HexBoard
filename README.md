...
- onboard synth waveform/wavetable banks, Serum/Vital and HexBoard wavetable import, mono portamento, AHDSR envelope, morph/wavetable/LFO modulation, preset, and arpeggiator settings

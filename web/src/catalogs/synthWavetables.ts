...
export const SYNTH_WAVETABLE_MIP_HARMONIC_LIMITS = [192, 96, 48, 24, 12, 6] as const;
...
export const HEXBOARD_SYSTEM_CLOCK_HZ = 200_000_000;
export const SYNTH_WAVETABLE_MIP_SAMPLE_RATE_HZ = Math.floor(HEXBOARD_SYSTEM_CLOCK_HZ / 1024 / 6);
